...
export default function Video() {
  ...
  let localStreamScreenShare = null;
  const localUserScreenShare = useRef();
  ...
  async function startScreenCapture() {
    ...
    localStreamScreenShare = screenCapture;
    const screenShareTrack = localStreamScreenShare.getTracks()[0];
    sender.replaceTrack(screenShareTrack);
    localUserScreenShare.current.srcObject = screenCapture;
  }

  function stopScreenCapture() {
    let tracks = localUserScreenShare.current.srcObject.getTracks();
    tracks.forEach((track) => track.stop());
    localUserScreenShare.current.srcObject = null;
}
    ...
    <div className={styles.pageContainer}>
      <div className={styles.videoContainer}>
        ...
        <video
          ...
          ref={remoteUser}
        ></video>
        <video style={{width: '400px'}} ref={localUserScreenShare} autoPlay></video>
      ...
      <div className={styles.formAndButtonContainer}>
        ...
        <button disabled={!isScreenBeingShared} onClick={stopScreenCapture}>
          Stop Screen Share
        </button>
